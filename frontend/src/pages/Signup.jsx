...
import { User, Mail, Lock, ArrowRight, Loader2, ShoppingBag } from 'lucide-react';
...
export default function Signup() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success(`Welcome to CampusCraves, ${data.user.name}!`);
            navigate('/');
        } catch (err) {
            ...
            <div className="w-full max-w-md bg-white shadow-2xl min-h-screen relative flex flex-col p-8 overflow-hidden">
                ...
                <div className="relative z-10 flex-1 flex flex-col justify-center">
                    <div className="mb-10 text-center">
                        ...
                        <h1 className="text-4xl font-black text-slate-900 tracking-tight tracking-tight">Create Account</h1>
                        <p className="text-slate-400 font-bold mt-2 uppercase tracking-widest text-[10px]">Join CampusCraves today</p>
                    </div>
                    ...
                    <p className="mt-10 text-center text-slate-400 font-bold text-xs uppercase tracking-widest">
                        ...
                        <Link to="/login" className="text-orange-600 hover:text-orange-700 underline decoration-2 underline-offset-4">Sign In</Link>
                    </p>
                </div>
            </div>
        </main>
